...
def format_axis(axis, fig, xticklabels=None, x_values=None, xlim=None, ylim=None, n_xticks=6, 
                xlabel=None, ylabel=None, grid=True, axis_title=None, arrowed_spines=True):
